...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        ...
        let (Ok(r), Ok(g), Ok(b)) = (u8::try_from(r), u8::try_from(g), u8::try_from(b)) else { return Err(IntoColorError::IntConversion); } ;
...
fn handle_err(err: TryFromIntError) -> IntoColorError {
